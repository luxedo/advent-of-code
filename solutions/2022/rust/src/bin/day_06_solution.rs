...
mod example {
    ...
    test_solution!(test0_1, solve_pt1, 7, TEST_DATA_0);
    test_solution!(test1_1, solve_pt1, 5, TEST_DATA_1);
    test_solution!(test2_1, solve_pt1, 6, TEST_DATA_2);
    test_solution!(test3_1, solve_pt1, 10, TEST_DATA_3);
    test_solution!(test4_1, solve_pt1, 11, TEST_DATA_4);

    test_solution!(test0_2, solve_pt2, 19, TEST_DATA_0);
    test_solution!(test1_2, solve_pt2, 23, TEST_DATA_1);
    test_solution!(test2_2, solve_pt2, 23, TEST_DATA_2);
    test_solution!(test3_2, solve_pt2, 29, TEST_DATA_3);
    test_solution!(test4_2, solve_pt2, 26, TEST_DATA_4);
}
