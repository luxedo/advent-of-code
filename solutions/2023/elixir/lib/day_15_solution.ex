defmodule Day15 do
  ...
  lenses available to further focus the light, the reindeer brings you a book titled "Initialization
  Manual".
  ...
  All 256 boxes are always present; only the boxes that contain any lenses are shown here. Within
  each box, lenses are listed from front to back; each lens is shown as its label and focal length
  in square brackets.
  ...
  @doc """
      iex> Day15.solve_pt1("rn=1,cm-,qp=3,cm=2,qp-,pc=4,ot=9,ab=5,pc-,pc=6,ot=7")
      1320
  """
  ...
  @doc """
      iex> Day15.solve_pt2("rn=1,cm-,qp=3,cm=2,qp-,pc=4,ot=9,ab=5,pc-,pc=6,ot=7")
      145
  """
  ...
  def main do
    ans1 =
      File.read!("../data/day_15_input.txt")
      |> Day15.solve_pt1()
